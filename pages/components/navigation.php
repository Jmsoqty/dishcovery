          ...
          <a href="./dashboard.php" class="logo-img w-100">
            <div class="text-center">
                <div style="display: inline-block; vertical-align: middle;">
                    <img src="../assets/img/logo.png" alt="logo" class="img-fluid w-50"/>
                </div>
                <div style="display: inline-block; vertical-align: middle;">
                    <label class="fw-bold">Dishcovery</label>
                </div>
            </div>
          </a>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./dashboard.php" aria-expanded="false">
                ...
                <span class="hide-menu">Your Feed</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./categories.php" aria-expanded="false">
                ...
                <span class="hide-menu">Browse Categories</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./bookmarks.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./groups.php" aria-expanded="false">
                ...
                <span class="hide-menu">Groups Manager</span>
              </a>
            </li>
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
